...
outfile = csv.DictWriter(open('readable_argument_preds.tsv', 'w'), fieldnames=['sentence', 'predicate', 'event_type', 'event_id', 'gold_argument', 'gold_span', 'role_type', 'arg_type', 'predicted_arguments', 'arg_question'])
outfile.writeheader()
